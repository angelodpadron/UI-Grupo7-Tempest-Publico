...
data class RelatedContentViewMapper(val id: String, val description: String, val title: String, val state: Boolean, val poster: String)
//CONTENTS mappers
...
data class SerieMapper(var id: String, var title: String, var description: String, var poster: String, var categories: MutableList<CategoryMapper>, var relatedContent: MutableList<RelatedContentViewMapper>, var seasons: MutableList<SeasonMapper>)
data class MovieMapper(var id:String, var title: String, var description: String, var poster: String, var video: String, var duration: Int, var actores: MutableList<String>, var directors: MutableList<String>, var categories: MutableList<CategoryMapper>, var relatedContent: MutableList<RelatedContentViewMapper>)
